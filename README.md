...
Answer: Routing is handled by JS that is already on the page, preventing an HTTP request. The information is on the end user saves time but not having to ping server or retrieve from a server 
